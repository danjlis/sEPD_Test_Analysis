...
void draw_scan(const int tile = 8, const double xorigin = 96., const double yorigin = 25., const double rot = 3*TMath::Pi()/2,  const double scale_x = 23., const double scale_y = 85.){
